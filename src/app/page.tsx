      ...
      <section className="relative px-4 py-24">
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-xl text-[#a0a0b0]">{t("sections.whatWeDoDesc")}</p>
          </motion.div>
      ...
      <section className="relative px-4 py-24">
        ...
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-xl text-[#a0a0b0]">{t("sections.featuredDesc")}</p>
          </motion.div>
      ...
      <section className="relative px-4 py-24">
        <div className="mx-auto max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-xl text-[#a0a0b0]">{t("sections.updatesDesc")}</p>
          </motion.div>
